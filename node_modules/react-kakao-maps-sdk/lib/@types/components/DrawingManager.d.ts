...
export declare type DrawingManagerProps<T extends kakao.maps.drawing.OverlayType = kakao.maps.drawing.OverlayType> = Partial<kakao.maps.drawing.OverlayOptions> & Pick<kakao.maps.drawing.OverlayOptions, `${T}Options`> & {
    /**
